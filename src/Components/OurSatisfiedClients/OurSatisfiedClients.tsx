...
const OurSatisfiedClients: React.FC = () => {
  return (
    <div>
        ...
        <div className="container mx-auto">
          <div className="lg:py-10">
            ...
            <div>
              ...
              >
                <SwiperSlide>
                  <div className="flex flex-col justify-center  p-6 shadow-md rounded-xl sm:px-12 bg-white text-black">
                    <Image
                      src="/client1.png"
                      width={128}
                      height={128}
                      alt="client"
                      className="mx-auto rounded-full bg-gray-500 aspect-square object-cover"
                    />
                    ...
                    <div className="space-y-4 text-center divide-y divide-gray-700">
                      ...
                      <div className="flex justify-center pt-2 space-x-4 align-center">
                        <a
                          ...
                          href="#"
                          aria-label="GitHub"
                          className="p-2 rounded-md text-black hover:text-yellow-400"
                        >
                          <svg
                            viewBox="0 0 496 512"
